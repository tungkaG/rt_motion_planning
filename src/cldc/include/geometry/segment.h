...
class ProjectionDomain;             // forward declaration
class PathSegments;                 // forward declaration
...
class Segment {
 public:
  ...
  /**
   * @return normal vector at the start of the segment (in pt_1, perpendicular to t_1).
   */
  Eigen::Vector2d normalSegmentStart() const;

  /**
   * @return normal vector at the end of the segment (in pt_2, perpendicular to t_2).
   */
  Eigen::Vector2d normalSegmentEnd() const;

  /**
   * @return tangent vector at the start of the segment (in pt_1, perpendicular to n_1).
   */
  Eigen::Vector2d tangentSegmentStart() const;

  /**
   * @return tangent vector at the end of the segment (in pt_2, perpendicular to n_2).
   */
  Eigen::Vector2d tangentSegmentEnd() const;

  /**
   *
   * Normal vector at a specific longitudinal coordinate (pseudo-normal)
   *
  ...
  /**
   *
   * Tangent vector at a specific longitudinal coordinate (pseudo-tangent)
   *
   * @param s_local longitudinal coordinate in local coordinate system of
   * segment
 ...
 private:
   ...
   *
   * @param s longitudinal coordinate in the local coordinate system of the segment
   * @return lambda
   */
