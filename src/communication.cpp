...
static const double PATH_DATA[409][2] = {
  { -157.98592136094146, -49.45232504653796},
...
int main(void)
{
  ...
  // allocate a RowMatrixXd on the heap
  auto path = std::make_shared<RowMatrixXd>(409, 2);

  // copy the static const PATH_DATA into it
  std::memcpy(path->data(), PATH_DATA, sizeof(PATH_DATA));
